...
tt["batch_slices2"] = tt.apply(
    lambda r: "_".join([str(r["batch"]).zfill(3), str(r["batch_slices"]).zfill(3)]),
    axis=1,
)

tt["batch_slices1"] = tt["batch_index"] // 10_000
tt["batch_slices3"] = tt.apply(
    lambda r: "_".join([str(r["batch"]).zfill(3), str(r["batch_slices1"]).zfill(3)]),
    axis=1,
)
...
tt["abs_max_batch"] = tt.groupby(["batch"])["signal"].transform(
    lambda x: np.max(np.abs(x))
)
tt["abs_min_batch"] = tt.groupby(["batch"])["signal"].transform(
...
tt["signal_batch_5k_min"] = tt.groupby("batch_slices2")["signal"].transform("min")
tt["signal_batch_5k_max"] = tt.groupby("batch_slices2")["signal"].transform("max")
tt["signal_batch_5k_std"] = tt.groupby("batch_slices2")["signal"].transform("std")
tt["signal_batch_5k_mean"] = tt.groupby("batch_slices2")["signal"].transform("mean")
tt["mean_abs_chg_batch_5k"] = tt.groupby(["batch_slices2"])["signal"].transform(
    lambda x: np.mean(np.abs(np.diff(x)))
)
tt["abs_max_batch_5k"] = tt.groupby(["batch_slices2"])["signal"].transform(
    lambda x: np.max(np.abs(x))
)
tt["abs_min_batch_5k"] = tt.groupby(["batch_slices2"])["signal"].transform(
    lambda x: np.min(np.abs(x))
)
...
tt["signal_batch_10k_min"] = tt.groupby("batch_slices3")["signal"].transform("min")
tt["signal_batch_10k_max"] = tt.groupby("batch_slices3")["signal"].transform("max")
tt["signal_batch_10k_std"] = tt.groupby("batch_slices3")["signal"].transform("std")
tt["signal_batch_10k_mean"] = tt.groupby("batch_slices3")["signal"].transform("mean")
tt["mean_abs_chg_batch_10k"] = tt.groupby(["batch_slices3"])["signal"].transform(
    lambda x: np.mean(np.abs(np.diff(x)))
)
tt["abs_max_batch_10k"] = tt.groupby(["batch_slices3"])["signal"].transform(
    lambda x: np.max(np.abs(x))
)
tt["abs_min_batch_10k"] = tt.groupby(["batch_slices3"])["signal"].transform(
    lambda x: np.min(np.abs(x))
)
